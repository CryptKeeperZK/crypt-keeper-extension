        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, snarkjs_1.groth16.fullProve({
                            identityTrapdoor: trapdoor,
                            identityNullifier: nullifier,
                            treePathIndices: merkleProof.pathIndices,
                            treeSiblings: merkleProof.siblings,
                            externalNullifier: (0, hash_1["default"])(externalNullifier),
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            ...
                            signal: bignumber_1.BigNumber.from(signal).toString(),
                            externalNullifier: bignumber_1.BigNumber.from(externalNullifier).toString(),
                            proof: (0, packProof_1["default"])(proof)
                        }];
            }
        });
    });
