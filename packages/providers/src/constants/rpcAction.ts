export enum RPCAction {
  ...
  HANDLE_VERIFIABLE_CREDENTIAL_REQUEST = "rpc/credentials/handleVerifiableCredentialRequest",
  ...
  ANNOUNCE_VERIFIABLE_PRESENTATION = "rpc/credentials/announceVerifiablePresentation",
  SIGN_AND_ANNOUNCE_VERIFIABLE_PRESENTATION = "rpc/credentials/signAndAnnounceVerifiablePresentation",
  HANDLE_VERIFIABLE_PRESENTATION_REQUEST = "rpc/credentials/handleVerifiablePresentationRequest",
