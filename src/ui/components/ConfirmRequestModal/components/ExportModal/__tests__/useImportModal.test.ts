...
import { IUseProofModalArgs, IUseProofModalData, useExportModal } from "../useExportModal";

describe("ui/components/ConfirmRequestModal/components/ProofModal/useExportModal", () => {
  ...
  test("should return initial data", async () => {
    const { result } = renderHook(() => useExportModal(defaultArgs));
