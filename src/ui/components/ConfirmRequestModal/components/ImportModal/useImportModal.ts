...
export const useImportModal = ({ pendingRequest, accept, reject }: IUseProofModalArgs): IUseProofModalData => {
  const [faviconUrl, setFaviconUrl] = useState("");
  const operation = PROOF_MODAL_TITLES[pendingRequest?.type as ProofType] || "Import Identities";
